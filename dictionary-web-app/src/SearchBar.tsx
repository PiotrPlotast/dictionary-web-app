  ...
  return (
    <div className="bg-searchBarBgColor dark:bg-darkThemeSearchBarBgColor flex justify-between px-6 py-3 rounded-2xl">
      <input
        ...
        id="search-bar"
        placeholder="Search"
        className="bg-searchBarBgColor dark:bg-darkThemeSearchBarBgColor text-[1rem] text-textColor dark:text-darkThemeTextColor font-bold w-full outline-secondaryColor"
